import { ForceReply, InlineKeyboardButton, InlineKeyboardMarkup, KeyboardButton, ReplyKeyboardMarkup, ReplyKeyboardRemove } from '../src/core/types/typegram';
type Hideable<B> = B & {
    hide?: boolean;
};
...
export * as button from '../src/button';
